...
describe('VirtualList', function () {
  ...
  test('should render a list of \'items\'', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_VirtualList["default"], {
  ...
  describe('ScrollTo', function () {
    test('should scroll to the specific item of a given index with scrollTo', function (done) {
      ...
      (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_VirtualList["default"], {
  ...
  describe('Voice Control', function () {
    ...
    test('should render "data-webos-voice-disabled" to outermost node of VirtualList', function () {
      var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_VirtualList["default"], {
        cbScrollTo: getScrollTo,
        clientSize: clientSize,
        dataSize: dataSize,
      ...
      var expected = true;
      var actual = subject.find(".".concat(_VirtualListModule["default"].virtualList)).prop('data-webos-voice-disabled');
      expect(actual).toBe(expected);
    });
  });
});