...
exports.VirtualListBasic = exports.itemSizesShape = exports.gridListItemSizeShape = exports["default"] = void 0;
...
var VirtualListBasic = /*#__PURE__*/function (_Component) {
  ...
  function VirtualListBasic(_props) {
    ...
    _this.updateScrollPosition = function (_ref) {
      ...
      if (_this.props.scrollMode === 'native') {
        ...
        _this.setScrollPosition(x, y, rtl);
      }
    };
    ...
    _this.applyStyleToNewNode = function (index) {
      ...
      _this.cc[key] = /*#__PURE__*/_react["default"].createElement("div", {
        className: _VirtualListModule["default"].listItem,
        key: key,
        ref: itemContainerRef,
        style: (_this2 = _this).composeStyle.apply(_this2, rest)
      }, itemRenderer(_objectSpread(_objectSpread(_objectSpread({}, childProps), componentProps), {}, {
        index: index
      })));
    };
  ...
  _createClass(VirtualListBasic, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      this.shouldUpdateBounds = false; // TODO: remove `this.hasDataSizeChanged` and fix useScroll
    ...
    value: function scrollToPosition(x, y) {
      ...
      if (this.props.scrollContentRef.current && this.props.scrollContentRef.current.scrollTo) {
        if (rtl) {
          x = _platform.platform.ios || _platform.platform.safari || _platform.platform.chrome >= 85 ? -x : this.scrollBounds.maxLeft - x;
        }
    ...
    value: function render() {
      var _this$props7 = this.props,
          ...
          voiceFocused = _this$props7['data-webos-voice-focused'],
          voiceGroupLabel = _this$props7['data-webos-voice-group-label'],
          voiceDisabled = _this$props7['data-webos-voice-disabled'],
          placeholderRenderer = _this$props7.placeholderRenderer,
          role = _this$props7.role,
          style = _this$props7.style,
          scrollMode = _this$props7.scrollMode,
          rest = _objectWithoutProperties(_this$props7, ["className", "data-webos-voice-focused", "data-webos-voice-group-label", "data-webos-voice-disabled", "placeholderRenderer", "role", "style", "scrollMode"]),
          cc = this.cc,
          isPrimaryDirectionVertical = this.isPrimaryDirectionVertical,
          primary = this.primary,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        ref: this.contentRef,
        role: role
      }), [].concat(_toConsumableArray(cc), [placeholderRenderer && placeholderRenderer(primary)])));
    }
  }], [{
...
VirtualListBasic.propTypes =
/** @lends ui/VirtualList.VirtualListBasic.prototype */
{
  /**
