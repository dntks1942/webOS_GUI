...
describe('FloatingLayer Specs', function () {
  ...
  test('should not render if FloatingLayer is not open', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Root, null, /*#__PURE__*/_react["default"].createElement(_FloatingLayer.FloatingLayerBase, null, /*#__PURE__*/_react["default"].createElement("p", null, "Hi"))));
    var expected = null;
    var actual = subject.find('FloatingLayer').instance().node;
    expect(actual).toBe(expected);
  });
  test('should render if FloatingLayer is open', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Root, null, /*#__PURE__*/_react["default"].createElement(_FloatingLayer.FloatingLayerBase, {
      open: true
