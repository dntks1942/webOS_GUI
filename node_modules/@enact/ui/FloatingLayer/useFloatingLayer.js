...
function useFloatingLayer() {
  var _React$useState = _react["default"].useState(null),
      ...
      floatingLayerId = _React$useState2[0],
      setId = _React$useState2[1];

  var handler = _react["default"].useCallback(function (ev) {
    if (ev.action === 'mount' && ev.floatingLayer) {
      setId(ev.floatingLayer.id);
    }
  }, [setId]);

  var registerFloatingLayer = _react["default"].useContext(_FloatingLayerDecorator.FloatingLayerContext);
