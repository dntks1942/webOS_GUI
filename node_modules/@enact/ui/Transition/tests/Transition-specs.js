...
describe('Transition Specs', function () {
  ...
  test.skip('should apply author classes', function () {
    ...
    var ChildNode = function ChildNode(props) {
      return /*#__PURE__*/_react["default"].createElement("div", props, "Body");
    };

    var wrapped = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Transition["default"], {
      className: className
    }, /*#__PURE__*/_react["default"].createElement(ChildNode, null)));
  ...
  test('should apply \'shown\' class when visible', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Transition.TransitionBase, null));
    var expected = 'shown';
    var actual = subject.find('div').at(0).prop('className');
    expect(actual).toContain(expected);
  });
  test('should apply \'hidden\' class when not visible', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Transition.TransitionBase, {
      visible: false
    }));
    var expected = 'hidden';
    var actual = subject.find('div').at(0).prop('className');
  ...
  propStyleCombination.forEach(function (_ref) {
    ...
    val.forEach(function (_ref3) {
      ...
      test("should apply classes for ".concat(prop, "=\"").concat(value, "\""), function () {
        ...
        var wrapped = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Transition["default"], Object.assign({}, propValue, {
          visible: true
        }), "Body"));
        var expected = key;
