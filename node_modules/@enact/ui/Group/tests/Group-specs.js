...
describe('Group', function () {
  ...
  test('should call handler with selected on select', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Group.GroupBase, {
      childComponent: "div",
  ...
  test('should set aria-multiselectable when select="multiple"', function () {
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Group.GroupBase, {
      childComponent: "div",
      select: "multiple"
    }, stringItems));
    var expected = true;
