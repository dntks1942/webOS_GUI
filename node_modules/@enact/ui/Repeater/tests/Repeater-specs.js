...
describe('Repeater Specs', function () {
  ...
  var CustomType = function CustomType(props) {
    return /*#__PURE__*/_react["default"].createElement("div", null, props.content);
  };

  test('should have a root span element', function () {
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Repeater.RepeaterBase, {
      childComponent: "div"
    }, stringItems));
    var expected = 'span';
