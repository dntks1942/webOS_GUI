...
describe('RadioDecorator', function () {
  ...
  test('should be activated when its prop is true on mount', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Controller, null, /*#__PURE__*/_react["default"].createElement(Component, {
      active: true
    })));
  ...
  test('should not be activated when its prop is false on mount', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Controller, null, /*#__PURE__*/_react["default"].createElement(Component, null)));
  ...
  test('should be activated when its prop is set to true after mount', function () {
    ...
    var Wrapper = function Wrapper(_ref2) {
      ...
      return (
        ...
        _react["default"].createElement(Controller, null, /*#__PURE__*/_react["default"].createElement(Component, {
          active: active
        }))
      );
    };

    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Wrapper, null));
    subject.setProps({
      active: true
    });
    var instance = subject.find('RadioDecorator');
  ...
  test('should not deactivate items in a ancestor controller', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Controller, null, /*#__PURE__*/_react["default"].createElement(Component, {
      active: true
    }), /*#__PURE__*/_react["default"].createElement(Component, null), /*#__PURE__*/_react["default"].createElement(Controller, {
  ...
  test('should not call deactivate callback on inactive items', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Wrapper, null)); // activate the second item via prop change
