...
describe('Item', function () {
  test('should create an Item that is enabled by default', function () {
    var item = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Item["default"], null, "I am an Item"));
    var expected = 0;
  ...
  test('should have \'disabled\' HTML attribute when \'disabled=true\'', function () {
    var item = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Item["default"], {
      disabled: true
