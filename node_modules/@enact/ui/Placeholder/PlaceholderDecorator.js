...
exports.PlaceholderDecorator = exports["default"] = void 0;
  ...
  return _temp = _class = /*#__PURE__*/function (_React$PureComponent) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        if (visible) {
          return /*#__PURE__*/_react["default"].createElement(Wrapped, Object.assign({}, this.props, {
            ref: this.initPlaceholderRef
          }));
        } else {
          return /*#__PURE__*/_react["default"].createElement(PlaceholderComponent, {
            ref: this.initPlaceholderRef,
    ...
    return _class;
  }(_react["default"].PureComponent), _class.displayName = 'PlaceholderDecorator', _class.contextType = _PlaceholderControllerDecorator.PlaceholderContext, _temp;
});
