...
var Toggle = /*#__PURE__*/function () {
  function Toggle(config) {
    ...
    this.handleActivate = (0, _handle.handle)(isEnabled, (0, _handle.adaptEvent)(function (ev, props) {
      return makeEvent(props, true);
    }, (0, _handle.forward)('onToggle')), (0, _handle.returnsTrue)(function (ev, props, context) {
      return context.onToggle(true);
    })).bindAs(this, 'handleActivate');
    this.handleDeactivate = (0, _handle.handle)(isEnabled, (0, _handle.adaptEvent)(function (ev, props) {
      return makeEvent(props, false);
    }, (0, _handle.forward)('onToggle')), (0, _handle.returnsTrue)(function (ev, props, context) {
      return context.onToggle(false);
    })).bindAs(this, 'handleDeactivate');
    this.handleToggle = (0, _handle.handle)(isEnabled, (0, _handle.adaptEvent)(function (ev, props, _ref2) {
      var value = _ref2.value;
      return makeEvent(props, !value);
    }, (0, _handle.forward)('onToggle')), (0, _handle.returnsTrue)(function (ev, props, _ref3) {
