...
describe('Router', function () {
  ...
  test('should render a single component matching the {path}', function () {
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Router.RouterBase, {
      routes: routes,
      path: "/app"
    }));
    var expected = 1;
  ...
  test('should render children into {component}', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Router.Router, {
      routes: routes,
      path: "/app/settings",
      component: component
    }));
  ...
  test('should render a different component when the routes change for the same {path}', function () {
    ...
    subject.setProps({
      path: '/app',
      children: [/*#__PURE__*/_react["default"].createElement(_Route["default"], {
        path: "app",
        component: NewView
      })]
    });
