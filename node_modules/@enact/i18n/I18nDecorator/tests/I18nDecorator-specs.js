...
describe('I18nDecorator', function () {
  ...
  test('should add rtl context parameter', function () {
    var Component = function Component(props) {
      return /*#__PURE__*/_react["default"].createElement("div", null, 'rtl' in props ? 'has rtl prop' : 'does not have rtl prop');
    };
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Wrapped, null));
  ...
  test('should add updateLocale context parameter', function () {
    ...
    var Component = function Component(_ref) {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, typeof update);
    };
  ...
  test('should set locale via props', function () {
    ...
    (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(Wrapped, {
      locale: "ar-SA"
    }));
    var expected = 'ar-SA';
  ...
  test('should add locale classes to Wrapped', function () {
    ...
    var subject = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(Wrapped, {
      locale: "en-US"
    })).find(Component);
    var expected = true;
