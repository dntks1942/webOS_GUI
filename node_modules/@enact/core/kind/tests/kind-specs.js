...
describe('kind', function () {
  ...
  test('should support undefined handlers', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Minimal, null));
    var actual = subject.find('div');
    expect(actual).toBeDefined();
  });
  test('should default {label} property', function () {
    var subject = /*#__PURE__*/_react["default"].createElement(Kind, {
      prop: 1
    });
  ...
  test('should add className defined in styles', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Kind, {
      prop: 1
    }));
    var expected = 'kind';
  ...
  test('support using hooks within kind instances', function () {
    var Comp = (0, _kind["default"])({
      ...
      render: function render() {
        ...
        var _React$useState = _react["default"].useState(0),
            ...
            setState = _React$useState2[1]; // eslint-disable-next-line react/jsx-no-bind
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Comp, null));
