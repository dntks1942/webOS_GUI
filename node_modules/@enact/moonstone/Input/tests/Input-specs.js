...
describe('Input Specs', function () {
  test('should have an input element', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Input["default"], null));
    expect(subject.find('input')).toHaveLength(1);
  });
  test('should include a placeholder if specified', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Input["default"], {
      placeholder: "hello"
    }));
  ...
  test('should set voice intent if specified', function () {
    var input = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Input["default"], {
