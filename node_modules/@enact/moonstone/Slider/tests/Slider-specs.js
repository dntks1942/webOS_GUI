...
describe('Slider', function () {
  ...
  test('should set "aria-valuetext" to hint string when knob is active and vertical is false', function () {
    var slider = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Slider["default"], null));
  ...
  test('should set "aria-valuetext" to hint string when knob is active and vertical is true', function () {
    var slider = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Slider["default"], {
  ...
  test('should activate the slider on enter keyup', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Slider["default"], null));
    activate(subject);
    var expected = 'active';
  ...
  test('should not activate the slider on enter when activateOnFocus', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Slider["default"], {
