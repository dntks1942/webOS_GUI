...
describe('ExpandableList', function () {
  describe('#aria-multiselectable', function () {
    test('should be true when select is multiple', function () {
      var expandableList = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ExpandableList.ExpandableListBase, {
        title: "Item",
        select: "multiple"
  ...
  test('should update when children are added', function () {
    ...
    var expandableList = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ExpandableList.ExpandableList, {
      title: "Item",
      open: true
    }, children));
