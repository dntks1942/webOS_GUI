...
describe('SelectableItem Specs', function () {
  test('should render no icon when not selected', function () {
    var selectableItem = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_SelectableItem["default"], null, "Hello SelectableItem"));
    var expected = 0;
  ...
  test('should render correct icon when selected', function () {
    var selectableItem = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_SelectableItem["default"], {
      selected: true
