  ...
  return _temp = _class = /*#__PURE__*/function (_Component) {
    ...
    _createClass(VirtualListCore, [{
      ...
      value: function render() {
        ...
        delete rest.wrap;
        return /*#__PURE__*/_react["default"].createElement(UiBase, Object.assign({}, rest, {
          itemRenderer: function itemRenderer(_ref8) {
            var _objectSpread2;

            var index = _ref8.index,
                itemRest = _objectWithoutProperties(_ref8, ["index"]);

            return (// eslint-disable-line react/jsx-no-bind
              _itemRenderer(_objectSpread(_objectSpread({}, itemRest), {}, (_objectSpread2 = {}, _defineProperty(_objectSpread2, _Scrollable.dataIndexAttribute, index), _defineProperty(_objectSpread2, "index", index), _objectSpread2)))
            );
          },
...
var listItemsRenderer = function listItemsRenderer(props) {
  var cc = props.cc,
      ...
      role = props.role;
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, cc.length ? /*#__PURE__*/_react["default"].createElement("div", {
    ref: initUiItemContainerRef,
    role: role
  }, cc) : null, primary ? null : /*#__PURE__*/_react["default"].createElement(SpotlightPlaceholder, {
    "data-index": 0,
...
var ScrollableVirtualList = function ScrollableVirtualList(_ref9) {
  var role = _ref9.role,
      rest = _objectWithoutProperties(_ref9, ["role"]);
  ...
  return /*#__PURE__*/_react["default"].createElement(_Scrollable.Scrollable, Object.assign({}, rest, {
...
var ScrollableVirtualListNative = function ScrollableVirtualListNative(_ref10) {
  var role = _ref10.role,
      rest = _objectWithoutProperties(_ref10, ["role"]);

  process.env.NODE_ENV !== "production" ? (0, _warning["default"])(!rest.itemSizes || !rest.cbScrollTo, 'VirtualList with `minSize` in `itemSize` prop does not support `cbScrollTo` prop') : void 0;
  return /*#__PURE__*/_react["default"].createElement(_ScrollableNative["default"], Object.assign({}, rest, {
    childRenderer: function childRenderer(childProps) {
      return (
        /*#__PURE__*/
        // eslint-disable-line react/jsx-no-bind
