...
describe('Spinner Specs', function () {
  test('should not have client node when Spinner has no children', function () {
    var spinner = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Spinner["default"], null));
    var expected = false;
  ...
  test('should have a client node when Spinner has children', function () {
    var spinner = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Spinner["default"], null, "Loading..."));
    var expected = true;
    var actual = spinner.find("div.".concat(_SpinnerModule["default"].client)).exists();
    expect(actual).toBe(expected);
  });
  ...
  test('should have transparent class when transparent prop equals true', function () {
    var spinner = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Spinner["default"], {
      transparent: true
    }, "Loading..."));
    var expected = true;
