...
describe('SharedStateDecorator Specs', function () {
  test('should provide a set method via context', function () {
    ...
    var Component = (0, _SharedStateDecorator["default"])(function () {
      return /*#__PURE__*/_react["default"].createElement(_SharedStateDecorator.SharedState.Consumer, null, function (value) {
        fn(value.set);
        return null;
      });
    });
    (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Component, null));
  ...
  test('should share data upstream when inside another SharedStateDecorator', function () {
    var Component = (0, _SharedStateDecorator["default"])(function (_ref) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_SharedStateDecorator.SharedState.Consumer, null, function (value) {
        value.set('key', 'value');
        return /*#__PURE__*/_react["default"].createElement("div", rest, /*#__PURE__*/_react["default"].createElement("span", null, value.get('key')), children);
      });
    });
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(Component, {
      id: "outer"
    ...
    var Base = /*#__PURE__*/function (_React$Component) {
      ...
      _createClass(Base, [{
        ...
        value: function render() {
          ...
          return /*#__PURE__*/_react["default"].createElement("div", rest, /*#__PURE__*/_react["default"].createElement("span", null, this.context.get('key')), children);
        }
      }]);
