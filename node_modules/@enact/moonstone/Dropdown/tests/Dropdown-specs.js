...
describe('Dropdown', function () {
  test('should have `title`', function () {
    var dropDown = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Dropdown.DropdownBase, {
      title: title
    }, children));
    var expected = title;
  ...
  test('should update when children are added', function () {
    var dropDown = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Dropdown.Dropdown, {
      title: title
    }, children));
  ...
  test('should set the `role` of items to "checkbox"', function () {
    var dropDown = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Dropdown.DropdownBase, {
      title: title,
      defaultOpen: true
    }, ['item']));
  ...
  describe('DropdownList', function () {
    test('should include `data` and `selected` in `onSelect` callback', function () {
      var handler = jest.fn();
      var dropDown = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_DropdownList["default"], {
        onSelect: handler
      }, children));
