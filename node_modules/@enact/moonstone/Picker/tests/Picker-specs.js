...
describe('Picker Specs', function () {
  test('should render selected child wrapped with <PickerItem/>', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Picker.Picker, {
      value: 1
    }, [1, 2, 3, 4]));
    var expected = '2';
  ...
  test('should be disabled when empty', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Picker.PickerBase, null, []));
  ...
  test('should set "data-webos-voice-disabled" to decrement button when voice control is disabled', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Picker.PickerBase, {
