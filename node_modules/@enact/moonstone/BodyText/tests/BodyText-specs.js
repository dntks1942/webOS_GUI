...
describe('BodyText Specs', function () {
  test('should support multi-line content', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_BodyText["default"], null));
    var expected = 1;
    var actual = subject.find('p').length;
    expect(actual).toBe(expected);
  });
  test('should support single-line marqueeing content when `noWrap` is true', function () {
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_BodyText["default"], {
      noWrap: true
    }));
    var expected = true;
