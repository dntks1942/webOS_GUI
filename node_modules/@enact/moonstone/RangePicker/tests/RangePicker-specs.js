...
describe('RangePicker Specs', function () {
  test('should render a single child with the current value', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_RangePicker.RangePicker, {
      min: -10,
      max: 20,
      value: 10
    }));
  ...
  test('should be disabled when limited to a single value', function () {
    var picker = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_RangePicker.RangePickerBase, {
      min: 0,
      max: 0,
      value: 0
    }));
