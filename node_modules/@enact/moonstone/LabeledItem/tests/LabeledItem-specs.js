...
describe('LabeledItem Specs', function () {
  ...
  test('should render a label (<div>) by default', function () {
    var item = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_LabeledItem["default"], {
      label: "The Label"
    }, "I am a labeledItem"));
  ...
  test('should not render a label if there is no \'label\' prop', function () {
    var item = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_LabeledItem["default"], null, "I am a labeledItem"));
    var divTag = item.find(labelClass);
    var expected = 0;
    var actual = divTag.length;
    expect(actual).toBe(expected);
  ...
  test('should have \'disabled\' HTML attribute when \'disabled=true\'', function () {
    var item = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_LabeledItem["default"], {
      disabled: true
