...
var LabeledItemBase = (0, _kind["default"])({
  ...
  render: function render(_ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement(Controller, Object.assign({
      disabled: disabled
    }, rest, {
      css: css
      ...
      className: css.title,
      marqueeOn: marqueeOn
    }, children), titleIcon != null ? /*#__PURE__*/_react["default"].createElement(_Icon["default"], {
      size: "small",
      className: css.icon
    }, titleIcon) : null), label != null ? /*#__PURE__*/_react["default"].createElement(_Marquee.Marquee, {
      disabled: disabled,
      className: css.label,
      marqueeOn: marqueeOn
    }, label) : null);
