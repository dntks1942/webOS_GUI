...
describe('SwitchItem Specs', function () {
  test('should contain a Switch', function () {
    var switchItem = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_SwitchItem["default"], null, "SwitchItem"));
    var expected = 1;
    var actual = switchItem.find('Switch').length;
    expect(actual).toBe(expected);
  });
  test('should pass selected to Switch element', function () {
    var switchItem = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_SwitchItem["default"], {
      selected: true
    }, "SwitchItem"));
