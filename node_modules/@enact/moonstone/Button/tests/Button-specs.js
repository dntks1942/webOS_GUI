...
describe('Button', function () {
  test('should have \'disabled\' HTML attribute when \'disabled\' prop is provided', function () {
    var button = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Button["default"], {
      disabled: true
  ...
  describe('events', function () {
    test('should call onClick when not disabled', function () {
      ...
      var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Button["default"], {
        onClick: handleClick
      }, "I am a disabled Button"));
    ...
    test('should have "Select" voice intent in the node of "role=button"', function () {
      var button = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Button["default"], null, "Hello"));
      var expected = 'Select';
