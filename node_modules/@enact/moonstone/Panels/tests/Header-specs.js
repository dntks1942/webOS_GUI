...
describe('Header Specs', function () {
  test('should render with title text without changing case', function () {
    ...
    var header = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Header["default"], null, /*#__PURE__*/_react["default"].createElement("title", null, msg)));
    var expected = msg;
    var actual = header.find('h1').text();
    expect(actual).toBe(expected);
  });
  test('should have fullBleed class applied', function () {
    var header = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Header["default"], {
      fullBleed: true
    }, /*#__PURE__*/_react["default"].createElement("title", null, "Header")));
    var expected = true;
  ...
  test('should inject a custom component when headerInput is used', function () {
    ...
    var header = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_Header["default"], null, /*#__PURE__*/_react["default"].createElement("title", null, "Header"), /*#__PURE__*/_react["default"].createElement("headerInput", null, /*#__PURE__*/_react["default"].createElement(Input, null))));
    var expected = 1;
