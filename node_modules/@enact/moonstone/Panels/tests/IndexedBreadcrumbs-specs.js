...
describe('IndexedBreadcrumbs', function () {
  ...
  test.skip('should call {onBreadcrumbClick} once when breadcrumb is clicked', function () {
    var handleClick = jest.fn();
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement("nav", null, (0, _IndexedBreadcrumbs["default"])('id', 1, 1, handleClick)));
