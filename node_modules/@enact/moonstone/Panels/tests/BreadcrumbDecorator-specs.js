...
describe('BreadcrumbDecorator', function () {
  ...
  test.skip('should wrap primitive breadcrumbs with Breadcrumb', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(SingleBreadcrumbPanels, {
      index: 2,
      breadcrumbs: ['1st', '2nd', '3rd']
    }, /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null)));
    var expected = '2nd';
  ...
  test.skip('should support custom breadcrumbs', function () {
    ...
    var breadcrumbs = [0, 1, 2].map(function (i) {
      return /*#__PURE__*/_react["default"].createElement(CustomBreadcrumb, {
        index: i
      });
    });
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(SingleBreadcrumbPanels, {
  ...
  test.skip('should generate {config.max} breadcrumbs', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(ThreeBreadcrumbPanels, {
      index: 3
    }, /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null)));
    var expected = 3;
  ...
  test.skip('should add {config.className} to the root node', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(StyledBreadcrumbPanels, null, /*#__PURE__*/_react["default"].createElement(Panel, null)));
    var expected = true;
  ...
  test.skip('should not set aria-owns when no breadcrumbs are needed', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(ThreeBreadcrumbPanels, {
      ...
      index: 0,
      noCloseButton: true
    }, /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null))); // eslint-disable-next-line
  ...
  test.skip('should set aria-owns on each Panel for the breadcrumbs', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(ThreeBreadcrumbPanels, {
      ...
      index: 3,
      noCloseButton: true
    }, /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null))); // tests for {config.max} aria-owns entries in the format ${id}_bc_{$index}
  ...
  test.skip('should set aria-owns on each Panel for the `max` breadcrumbs', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(ThreeBreadcrumbPanels, {
      ...
      index: 3,
      noCloseButton: true
    }, /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null))); // tests for truncated {config.max} aria-owns entries in the format ${id}_bc_{$index}
  ...
  test.skip('should append breadcrumb aria-owns to set aria-owns value in childProps', function () {
    ...
    }, /*#__PURE__*/_react["default"].createElement(Panel, null), /*#__PURE__*/_react["default"].createElement(Panel, null)));
