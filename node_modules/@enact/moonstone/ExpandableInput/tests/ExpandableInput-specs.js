...
describe('ExpandableInputBase', function () {
  ...
  describe('#aria-label', function () {
    test('should use title, value, and input hint', function () {
      var subject = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_ExpandableInput.ExpandableInputBase, {
        title: "Item",
        value: "value"
      }));
...
describe('ExpandableInput', function () {
  test('should pass onChange callback to input', function () {
    ...
    var subject = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_ExpandableInput.ExpandableInput, {
      title: "Item",
      open: true,
