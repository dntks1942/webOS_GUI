...
describe('Popup specs', function () {
  test('should be rendered opened if open is set to true', function () {
    var popup = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(FloatingLayerController, null, /*#__PURE__*/_react["default"].createElement(_Popup.Popup, {
      open: true
    }, /*#__PURE__*/_react["default"].createElement("div", null, "popup"))));
    var expected = true;
    var actual = popup.find('FloatingLayer').prop('open');
    expect(actual).toBe(expected);
  });
  test('should not be rendered if open is set to false', function () {
    var popup = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(FloatingLayerController, null, /*#__PURE__*/_react["default"].createElement(_Popup.Popup, null, /*#__PURE__*/_react["default"].createElement("div", null, "popup"))));
    var expected = false;
    var actual = popup.find('FloatingLayer').prop('open');
    expect(actual).toBe(expected);
  });
  test('should set popup close button "aria-label" to closeButtonAriaLabel', function () {
    ...
    var popup = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Popup.PopupBase, {
  ...
  test('should set role to alert by default', function () {
    var popup = (0, _enzyme.shallow)( /*#__PURE__*/_react["default"].createElement(_Popup.PopupBase, null, /*#__PURE__*/_react["default"].createElement("div", null, "popup")));
    var expected = 'alert';
