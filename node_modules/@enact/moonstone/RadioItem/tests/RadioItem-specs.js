...
describe('RadioItem Specs', function () {
  test('should render correct icon when not selected', function () {
    var radioItem = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_RadioItem["default"], null, "Hello RadioItem"));
    var expected = 0;
  ...
  test('should render correct icon when selected', function () {
    var radioItem = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_RadioItem["default"], {
      selected: true
    }, "Hello RadioItem"));
    var expected = 1;
    var actual = radioItem.find(".".concat(_RadioItemModule["default"].selected)).length;
